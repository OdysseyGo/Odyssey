...
def test_metrics_logic():
    ...
    with patch("apps.tours.utils.googlemaps.Client") as MockClient:
        ...
        client.directions.return_value = [{
            "legs": [
                {"distance": {"value": 500}, "duration": {"value": 300}, "end_location": {"lat": 10, "lng": 10}},
                {"distance": {"value": 2500}, "duration": {"value": 1500}, "end_location": {"lat": 10, "lng": 10}},
                {"distance": {"value": 500}, "duration": {"value": 300}, "end_location": {"lat": 10, "lng": 10}}
            ],
        ...
        client.elevation.return_value = [
            {"elevation": 0}, {"elevation": 10}, {"elevation": 20}, {"elevation": 30}
        ]
        
        # Helper for decoding polyline mock
        with patch("apps.tours.utils.googlemaps.convert.decode_polyline", return_value=[(10,10)]*4):
            ...
            assert metrics["requires_transport"] == True 
            ...
            # 500m, 5 min, 0 elev, max leg 500m
             # MOCK DATA 2
            client.directions.return_value = [{
                "legs": [{"distance": {"value": 500}, "duration": {"value": 300}, "end_location": {"lat": 10, "lng": 10}}],
                "overview_polyline": {"points": "mock_polyline"}
            }]
            client.elevation.return_value = [{"elevation": 10}, {"elevation": 10}] # Flat
