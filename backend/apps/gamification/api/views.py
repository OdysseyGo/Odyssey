...
class TourProgressViewSet(
    ...
    def _snapshot_for_tour(self, tour):
        return TourSerializer(tour, context={"request": self.request}).data

    @staticmethod
    def _find_snapshot_step(snapshot, step_id):
    ...
    @staticmethod
    def _get_current_step(progress):
    ...
    def create(self, request, *args, **kwargs):
        ...
        snapshot = self._snapshot_for_tour(tour)
        ...
        if existing_progress and existing_progress.status == TourProgress.COMPLETED:
            ...
            with transaction.atomic():
                ...
                existing_progress.tour_snapshot = snapshot
                existing_progress.current_step_id = first_step_id
    ...
    def submit_trivia_answer(self, request, pk=None):
        ...
        current_step = self._get_current_step(progress)
